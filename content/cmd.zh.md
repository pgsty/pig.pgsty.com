...
- [**pig pitr**](/zh/pitr/)：进行完整 PITR 工作流
...
管理 PostgreSQL 软件包的 APT/YUM 仓库，详情请参考 [`pig repo`](/zh/repo/)
...
管理 PostgreSQL 扩展和内核包，详情请参考 [`pig ext`](/zh/ext/)
...
从源码构建 PostgreSQL 扩展，详情请参考 [`pig build`](/zh/build/)
...
安装 Pigsty 发行版，详情请参考 [`pig sty`](/zh/sty/)
...
详情请参考 [`pig inventory`](/zh/inventory/)。（v1.6.0 新增）
...
管理本地 PostgreSQL 服务器，详情请参考 [`pig pg`](/zh/pg/)
...
透明运行 `patronictl` 管理 Patroni HA 集群，详情请参考 [`pig pt`](/zh/pt/)
...
管理 pgBackRest 备份与恢复，详情请参考 [`pig pb`](/zh/pb/)
...
执行编排式时间点恢复（PITR），详情请参考 [`pig pitr`](/zh/pitr/)
