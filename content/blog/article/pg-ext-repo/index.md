...
[**PostgreSQL Is Eating the Database World**](https://vonng.com/en/pg/pg-eat-db-world/) through the power of **extensibility**.
...
[![PostgreSQL extension ecosystem](/article/pg-ext-repo/ecosystem.webp)](https://vonng.com/en/pg/pg-eat-db-world/)
...
PGDG has already made a fantastic effort with official [YUM](https://download.postgresql.org/pub/repos/yum/) and [APT](https://apt.postgresql.org/pub/repos/apt/) repositories.
...
[![PGDG extension availability matrix](/article/pg-ext-repo/pgdg-ext.webp)](/article/pg-ext-repo/pgdg-ext.webp)
...
[`pg_search`](https://pigsty.io/ext/e/pg_search/) as an Elasticsearch alternative; and the now-archived [`pg_analytics`](https://github.com/paradedb/pg_analytics), [`pg_parquet`](https://pigsty.io/ext/e/pg_parquet/), and [`pg_mooncake`](https://pigsty.io/ext/e/pg_mooncake/) for OLAP processing. The reason? They are too slow to compile...
...
[![Pigsty extension availability matrix](/article/pg-ext-repo/pigsty-ext.webp)](https://pigsty.io/ext/list/)
...
[![Citus extension detail page](/article/pg-ext-repo/citus.webp)](https://pigsty.io/ext/e/citus/)
...
[![Linux x86_64](https://img.shields.io/badge/Linux-x86_64-%23FCC624?style=flat&logo=linux&labelColor=FCC624&logoColor=black)](https://pigsty.io/docs/pgsql/ext/repo/#apt-repository)
[![Ubuntu 24.04 support](https://img.shields.io/badge/Ubuntu-24/noble-%23E95420?style=flat&logo=ubuntu&logoColor=%23E95420)](https://pigsty.io/ext/os/u24.x86_64/)
[![Ubuntu 22.04 support](https://img.shields.io/badge/Ubuntu-22/jammy-%23E95420?style=flat&logo=ubuntu&logoColor=%23E95420)](https://pigsty.io/ext/os/u22.x86_64/)
[![Debian 12 support](https://img.shields.io/badge/Debian-12/bookworm-%23A81D33?style=flat&logo=debian&logoColor=%23A81D33)](https://pigsty.io/ext/os/d12.x86_64/)
...
[![Linux x86_64](https://img.shields.io/badge/Linux-x86_64-%23FCC624?style=flat&logo=linux&labelColor=FCC624&logoColor=black)](https://pigsty.io/docs/pgsql/ext/repo/#yum-repository)
[![EL 9 support](https://img.shields.io/badge/EL-9-red?style=flat&logo=redhat&logoColor=red)](https://pigsty.io/ext/os/el9.x86_64/)
[![EL 8 support](https://img.shields.io/badge/EL-8-red?style=flat&logo=redhat&logoColor=red)](https://pigsty.io/ext/os/el8.x86_64/)
[![RHEL-compatible RPM packages](https://img.shields.io/badge/RPM-packages-slategray?style=flat&logo=redhat&logoColor=red)](https://pigsty.io/ext/rpm/)
[![AlmaLinux compatible](https://img.shields.io/badge/AlmaLinux-compatible-slategray?style=flat&logo=almalinux&logoColor=black)](https://almalinux.org/)
...
[![GitHub contribution activity](/article/pg-ext-repo/github-contrib.webp)](https://github.com/Vonng)
...
> **Archive note (2026-08-30):** First published on [vonng.com](https://vonng.com/en/pg/pg-ext-repo/). Package counts, screenshots, and surrounding context reflect that date. For current behavior, use the [PIG documentation](/docs/) and live [extension catalog](https://pigsty.io/ext/).
