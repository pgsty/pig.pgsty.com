...
[Stack Overflow 开发者调查](https://vonng.com/pg/so2025-pg/) 显示，专业开发者中 PostgreSQL 的使用率达到 **58.2%**，甩开第二名 MySQL **18.6** 个百分点，而且这个比例还在加速增长。
从新开源项目，AI SaaS 到 OpenAI 这样的独角兽，PG 已经成为新项目的标配 “默认” 数据库。

![PostgreSQL 使用与市场趋势数据](/article/forge-a-pg-distro/pg-used-data.webp)
...
[Databricks 斥资约 10 亿美元收购了 PostgreSQL 初创公司 Neon](https://mp.weixin.qq.com/s/skxFplC0ow0Hh9gqs_N4hQ)，而 [Snowflake 则以 2.5 亿美元收购了 Crunchy Data](https://vonng.com/db/db-for-ai/)。
两大数据平台巨头通过收购杀入 PostgreSQL 的 OLTP 市场——他们选的不是 MySQL，也不是自研新库，而是直接押注 PostgreSQL。

![全球数据库厂商围绕 PostgreSQL 的产业动向](/article/forge-a-pg-distro/industry.webp)
...
![PostgreSQL 开源生态中的中国项目](/article/forge-a-pg-distro/china-pg-oss.webp)
...
我这两年参加了几场 [国际 PostgreSQL 会议](https://vonng.com/pg/pgcondev-2024/)，感受很复杂。
...
![Linux 内核与发行版的分层关系](/article/forge-a-pg-distro/distro.webp)
...
![PostgreSQL 内核与发行版的分层关系](/article/forge-a-pg-distro/pg-distro.webp)
...
![PostgreSQL 发行版面向的用户群体](/article/forge-a-pg-distro/users.webp)
...
![主流 PostgreSQL 发行版的 GitHub Star 历史](/article/forge-a-pg-distro/star-history.webp)

至少我证明了：一个中国开发者，用正确的方法，也可以在 PG 全球生态里占有一席之地，拿到了一张决赛圈的门票。

![Claude 对 PostgreSQL 发行版生态的分析](/article/forge-a-pg-distro/claude.webp)

> Claude Opus 4.5: PG 生态发行版格局分析

![Gemini 对 PostgreSQL 发行版生态的分析](/article/forge-a-pg-distro/gemini.webp)
...
![Pigsty 自建 PostgreSQL 服务能力概览](/article/forge-a-pg-distro/intro.webp)
...
![Pigsty 面向开发者的 PostgreSQL 使用体验](/article/forge-a-pg-distro/developers.webp)
...
![PostgreSQL 扩展生态全景图](/article/forge-a-pg-distro/ecosystem.webp)

我意识到：扩展才是 PostgreSQL 最大的价值所在。MySQL 想加向量搜索，折腾很久效果还不好。
PG 呢？一个社区开发者写了 pgvector，几个扩展一起赛马，直接把这个赛道卷没了，这就是可扩展架构的威力。

去年我写了一篇文章[《PostgreSQL 正在吞噬数据库世界》](https://vonng.com/pg/pg-eat-db-world/)，发到 Hacker News 火了，传遍整个 PG 社区。
...
![437 个 PostgreSQL 扩展的软件包覆盖统计](/article/forge-a-pg-distro/437-ext.webp)
...
![PGEXT.CLOUD 扩展目录首页](/article/forge-a-pg-distro/pgext-cloud.webp)
...
![PostgreSQL 上游与下游软件仓库的关系](/article/forge-a-pg-distro/upstream-repo.webp)
...
![PostgreSQL 分支内核的软件包交付矩阵](/article/forge-a-pg-distro/kernel-deliver.webp)
...
![面向 PostgreSQL 厂商的生态合作邀请](/article/forge-a-pg-distro/vendor-invite.webp)
...
![打造面向全球的 PostgreSQL 发行版](/article/forge-a-pg-distro/featured.webp)

---

> **归档说明（2026-08-30）：** 本文原载 [vonng.com](https://vonng.com/pg/forge-a-pg-distro/)。文中的软件包数量、截图与上下文以原始发表日期为准；当前行为请以 [PIG 文档](/zh/docs/)和实时[扩展目录](https://pigsty.cc/ext/)为准。
