...
[![用户在 GitHub Issue 中请求为 RDKit 软件包启用 InChI 支持](/article/extension-504/rdkit1.webp)](https://github.com/pgsty/pigsty/issues/738)
...
![维护者回复并重新构建已启用 InChI 的 RDKit 软件包](/article/extension-504/rdkit2.webp)
...
> [`pg_slug_gen`](https://pigsty.cc/ext/e/pg_slug_gen) | [GitHub](https://github.com/nandoolle/pg_slug_gen)
...
> **归档说明（2026-08-30）：** 本文原载 [vonng.com](https://vonng.com/pg/extension-504/)。文中的软件包数量、截图与上下文以原始发表日期为准；当前行为请以 [PIG 文档](/zh/docs/)和实时[扩展目录](https://pigsty.cc/ext/)为准。
