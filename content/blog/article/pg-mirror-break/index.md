...
![TUNA PostgreSQL mirror stopped at an old sync timestamp](/article/pg-mirror-break/tsinghua.webp)
...
![Alibaba Cloud PostgreSQL mirror stopped at an old sync timestamp](/article/pg-mirror-break/aliyun.webp)
...
[![PostgreSQL mailing-list reply announcing the FTP and rsync shutdown](/article/pg-mirror-break/maillist.webp)](https://www.postgresql.org/message-id/CA%2BOCxoz3p4LqyE4aNb3M8gs2GND25ET%3DEMQ-KSrZ%2BB1WRSdT4Q%40mail.gmail.com)
...
![PGDG repository traffic and server architecture](/article/pg-mirror-break/ftp-org.webp)

> [PGConf.dev 2025 session: Designing and Implementing a Monitoring Feature in PostgreSQL](https://www.pgevents.ca/events/pgconfdev2025/schedule/session/385-designing-and-implementing-a-monitoring-feature-in-postgresql/)
...
![The hidden maintenance burden behind open-source infrastructure](/article/pg-mirror-break/hidden-part.webp)
...
![Report sent to the TUNA mailing list about PostgreSQL mirror synchronization](/article/pg-mirror-break/tsinghua-maillist.webp)
...
![Illustration of dependency on an upstream software supply chain](/article/pg-mirror-break/prymaid.webp)
...
> **Archive note (2026-08-30):** First published on [vonng.com](https://vonng.com/en/pg/pg-mirror-break/). Package counts, screenshots, and surrounding context reflect that date. For current behavior, use the [PIG documentation](/docs/) and live [extension catalog](https://pigsty.io/ext/).
