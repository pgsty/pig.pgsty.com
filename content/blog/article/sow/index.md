...
![SOW project homepage](/article/sow/sow-home.webp)
...
The name deserves an explanation. We previously built a companion project, [**Pig—PostgreSQL Install Genius**](/article/pig/), the package manager for the PostgreSQL ecosystem. If a little Pig installs the packages, then the tool that produces, stores, organizes, and distributes those artifacts naturally has to be its mother: SOW.

![A USB hub shaped like a sow](/article/sow/sow-usb-hub.webp)
...
![The historical origin of the sow and pig terminology in pig-iron casting](/article/sow/pig-iron.webp)
...
![Traditional repository synchronization spends most of its time walking and comparing files](/article/sow/rclone-sync.webp)
...
![SOW's self-contained binary and incremental publishing model](/article/sow/sow-features.webp)
...
![Documentation for a SOW Plain repository](/article/sow/plain-repo-docs.webp)
...
![The four layers of SOW's Managed mode](/article/sow/managed-hierarchy.webp)
...
![SOW's package pool with RPM and APT metadata views](/article/sow/package-pool.webp)
...
![SOW's capability matrix for Plain and Managed modes](/article/sow/sow-capabilities.webp)
...
![SOW command index](/article/sow/sow-commands.webp)
...
- [**Silo**](https://vonng.com/en/db/long-live-silo/): the grain bin, responsible for S3-compatible object storage;
- [**Oink**](https://vonng.com/en/db/oink-release/): the sound pigs make, powering the documentation and website framework;
...
> **Archive note (2026-08-30):** First published on [vonng.com](https://vonng.com/en/db/sow/). Package counts, screenshots, and surrounding context reflect that date. For current behavior, use the [PIG documentation](/docs/) and live [extension catalog](https://pigsty.io/ext/).
