...
![PGEXT Day 2025 活动海报](/article/pgext-day/featured.webp)
...
![PGEXT Day 2025 分享主题](/article/pgext-day/topic.webp)

PGEXT DAY 的举办日期是 2025.05.12 日，和 PG 开发者大会在相同的地点 —— 加拿大魁北克省蒙特利尔市，Plaza Centre-Ville。扩展峰会之后紧接着 12 - 16 号就是 PG 大会主会的日程了。

![PGEXT Day 在蒙特利尔 Plaza Centre-Ville 的会场](/article/pgext-day/venue.webp)

[去年 PG 开发者大会在温哥华举办，参加之后感觉收获满满](https://vonng.com/pg/pgcondev-2024/)，可惜来自中国的参加者寥寥无几。不知道这一届怎么样，如果您也会去现场欢迎留言，我们可以在现场碰一碰，线下面基。
...
![PGEXT Day 2025 日程安排](/article/pgext-day/schedule.webp)
...
[`pg_tle`](https://pigsty.cc/ext/e/pg_tle/) 为开发者打开了一扇新大门，让任何人都能在无超级用户权限的前提下编写并部署安全的扩展。它还提供一些钩子，供受信任语言的函数使用，例如强制执行密码策略。 而 `pl/<any>` 则进一步允许使用任意语言来编写数据库函数，从而实现扩展。其主要途径是在 JavaScript 中编写 Language Handler，并利用任意可被转译到 JavaScript 的语言，成为 PostgreSQL 的嵌入式（或“pl/”）语言。
...
> **归档说明（2026-08-30）：** 本文原载 [vonng.com](https://vonng.com/pg/pgext-day/)。文中的软件包数量、截图与上下文以原始发表日期为准；当前行为请以 [PIG 文档](/zh/docs/)和实时[扩展目录](https://pigsty.cc/ext/)为准。
