...
扩展是 PostgreSQL 的灵魂。没有扩展的 PostgreSQL，只是一个普通的关系型数据库；有了扩展的 PostgreSQL，[才是那个能吞噬整个数据库世界的超级平台](https://vonng.com/pg/pg-eat-db-world/)。
...
![PG 扩展百科全书首页](/article/pgext-pedia/featured.webp)
...
![扩展详情页](/article/pgext-pedia/detail.webp)

此外，我们还收录了 460+ 扩展文档，让你可以在一个地方直接浏览大量 PG 扩展的双语文档，而不是在分散的页面之间来回跳转。

![扩展文档总览](/article/pgext-pedia/docs.webp)
...
![扩展分类总览](/article/pgext-pedia/categories.webp)
...
![扩展总量统计](/article/pgext-pedia/extstats.webp)

![文档覆盖统计](/article/pgext-pedia/docstats.webp)

![平台覆盖统计](/article/pgext-pedia/osstats.webp)

![软件包分发统计](/article/pgext-pedia/pkgstats.webp)
...
![扩展元数据与网站仓库](/article/pgext-pedia/source.webp)

## 附：Extension for Everyone

原稿末尾还附了一张相关主题演讲的海报，这里一并保留下来。

![Extension for Everyone 主题海报](/article/pgext-pedia/poster.webp)
...
> **归档说明（2026-08-30）：** 本文原载 [vonng.com](https://vonng.com/pg/pgext-pedia/)。文中的软件包数量、截图与上下文以原始发表日期为准；当前行为请以 [PIG 文档](/zh/docs/)和实时[扩展目录](https://pigsty.cc/ext/)为准。
