...
![PIG 包管理器与 PostgreSQL 大象](/article/pig/featured.webp)
...
![PostgreSQL 扩展生态全景图](/article/pig/ecosystem.webp)

为什么插件对 PG 至关重要？请参阅《[PostgreSQL正在吞噬数据库世界](https://vonng.com/pg/pg-eat-db-world)》
...
[![PostgreSQL 官方下载页面](/article/pig/pgdg-web.webp)](https://www.postgresql.org/download/)

> [PostgreSQL 官方下载页面](https://www.postgresql.org/download/)
...
![PGDG 扩展在 RPM 与 DEB 仓库中的可用性对比](/article/pig/pgdg-ext.webp)
...
![TimescaleDB 扩展的软件包可用性矩阵](/article/pig/timescale.webp)
...
这 340 个扩展的质量很高，是已经经过我严格筛选后的结果。一些没鸡毛用的扩展，缺乏维护，年久失修的扩展，代码质量差的扩展，无法跨平台兼容的扩展，已经被我无情淘汰了大概二三十个了。我们有一个 [PGEXT.CLOUD 扩展目录](https://pgext.cloud/zh/)，详细收录了这 340 个扩展的元数据详情。在 pig 命令行工具里面也提供了检索与查阅详情的能力。

![Pigsty 仓库的 Cloudflare 下载流量](/article/pig/cf-traffic.webp)
...
![Tembo Trunk PostgreSQL 扩展目录](/article/pig/trunk.webp)
...
![pgxman PostgreSQL 扩展目录](/article/pig/pgxman.webp)
...
![Pigsty 扩展仓库可用性矩阵](/article/pig/pigsty-ext.webp)
...
![Apache Pig 项目标志](/article/pig/apache-pig.webp)
...
![小猪骑着 PostgreSQL 大象](/article/pig/elephant.webp)

---

> **归档说明（2026-08-30）：** 本文原载 [vonng.com](https://vonng.com/pg/pig/)。文中的软件包数量、截图与上下文以原始发表日期为准；当前行为请以 [PIG 文档](/zh/docs/)和实时[扩展目录](https://pigsty.cc/ext/)为准。
