...
Yesterday’s post “[PG ‘Export Controls’ and Supply-Chain Trust](/article/pg-mirror-pigsty/)” drew a comment from someone claiming to be an admin at a university mirror site (Tsinghua TUNA):

> “As a university mirror admin, calling us ‘lying flat’ or ‘irresponsible’ is unfair and demoralizing.”

![Comment from a university mirror administrator](/article/tuna-mirror-site/comment.webp)

I replied:

> Thanks for the feedback and for everything TUNA/university mirrors have done over the years. I see the PostgreSQL repo [had synced again at the time](/article/tuna-mirror-site/tuna.webp)—credit where it’s due.
>
...
![TUNA PostgreSQL 18 package directory at the time of the discussion](/article/tuna-mirror-site/tuna.webp)
...
![Stale Alibaba Cloud PostgreSQL mirror directory](/article/tuna-mirror-site/aliyun.webp)
...
![Pigsty architecture and repository overview](/article/tuna-mirror-site/pigsty.webp)
...
| [TigerBeetle](https://github.com/tigerbeetle/tigerbeetle) 0.16.60 | | [pgbackrest_exporter](https://github.com/woblerr/pgbackrest_exporter) 0.21.0 | | [grafana-plugins](https://github.com/pgsty/infra-pkg/tree/main/grafana-plugins) 12.0.0 | |
...
| [pev2](https://github.com/dalibo/pev2) 1.17.0 | | [redis_exporter](https://github.com/oliver006/redis_exporter) 1.80.0 | | [genai-toolbox](https://github.com/googleapis/genai-toolbox) 0.18.0 | |
...
> **Archive note (2026-08-30):** First published on [vonng.com](https://vonng.com/en/db/tuna-mirror-site/). Package counts, screenshots, and surrounding context reflect that date. For current behavior, use the [PIG documentation](/docs/) and live [extension catalog](https://pigsty.io/ext/).
